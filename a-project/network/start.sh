...
function replacePrivateKey() {
    ...
    sed -i "s/CA_PRIVATE_KEY/${PRIV_KEY}/g" docker-compose-template.yml
}
...
docker-compose -f docker-compose-template.yml up -d ca.example.com orderer.example.com peer0.org1.example.com  peer0.org2.example.com peer0.org3.example.com cli
docker ps -a
